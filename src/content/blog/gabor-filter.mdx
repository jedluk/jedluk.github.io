...
<div class="flex flex-col gap-2 items-center sm:flex-row justify-center flex-wrap [&>img]:grow [&>img]:h-[150px] sm:[&>img]:h-[250px]">
...
complex Gabor function calculated at discrete points. Example masks you can find below (see how frequency and orientation effects on mask shape).

<div class="px-2 flex flex-col sm:flex-row gap-2 items-center justify-center">

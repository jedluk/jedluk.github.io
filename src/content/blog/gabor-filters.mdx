...
<div class="flex flex-col items-center sm:flex-row justify-center flex-wrap [&>img]:w-[48%]">
...
OK, now you can ask long awaited question: where it is actually used ? It turns out that it is used in image processing.
